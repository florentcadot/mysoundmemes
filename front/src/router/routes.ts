...
const routes: RouteConfig[] = [
  ...
  },
  {
    ...
    component: () => import('src/app/adapter/primary/views/layout/app.layout.vue'),
    children: [
      { path: '', component: () => import('src/app/adapter/primary/views/pages/board-detail.page.vue') }
    ],
    meta: {
      requiresAuth: true
    },
  ...
  },
  {
    ...
    component: () => import('src/app/adapter/primary/views/layout/app.layout.vue'),
    children: [
      { path: '', component: () => import('src/app/adapter/primary/views/pages/setting-user-account.page.vue') }
    ],
    meta: {
      requiresAuth: true
    }
